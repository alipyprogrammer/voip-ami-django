...
def Call_log_report_excell(Start, End, Type, Agent:list, Queuename:list,company):
    ...
    try:
        ...
        if Type=='call':
            ...
            voip_report['مجموع'] = voip_report["مدت میسکال"] + voip_report["قطع شده توسط کاربر"] + voip_report["قطع شده توسط مراجع"] 
            voip_report['مجموع'] = voip_report['مجموع'].where(voip_report["تعداد میسکال"] == 0, voip_report["قطع شده توسط کاربر"] + voip_report["قطع شده توسط مراجع"])
